...
-- Floor 1: Interior, Ocean View, Balcony
...
('102', 1, 'ocean', 129.00, 'available', 'Enjoy stunning ocean views from your private window', 'Ocean view window, Queen bed, Sitting area, Mini-fridge, Room service'),
('103', 1, 'balcony', 189.00, 'available', 'Private balcony with breathtaking ocean panoramas', 'Private balcony, Queen bed, Sitting area, Mini-bar, Priority boarding');

-- Floor 2: Interior, Ocean View, Balcony
INSERT INTO `rooms` (`room_number`, `floor`, `room_type`, `price_per_night`, `status`, `description`, `features`) VALUES
...
('202', 2, 'ocean', 129.00, 'available', 'Enjoy stunning ocean views from your private window', 'Ocean view window, Queen bed, Sitting area, Mini-fridge, Room service'),
('203', 2, 'balcony', 189.00, 'available', 'Private balcony with breathtaking ocean panoramas', 'Private balcony, Queen bed, Sitting area, Mini-bar, Priority boarding');

-- Floor 3: Interior, Ocean View, Suite
INSERT INTO `rooms` (`room_number`, `floor`, `room_type`, `price_per_night`, `status`, `description`, `features`) VALUES
...
('302', 3, 'ocean', 129.00, 'available', 'Enjoy stunning ocean views from your private window', 'Ocean view window, Queen bed, Sitting area, Mini-fridge, Room service'),
...
-- Floor 4: Ocean View, Balcony, Suite
INSERT INTO `rooms` (`room_number`, `floor`, `room_type`, `price_per_night`, `status`, `description`, `features`) VALUES
('401', 4, 'ocean', 129.00, 'available', 'Enjoy stunning ocean views from your private window', 'Ocean view window, Queen bed, Sitting area, Mini-fridge, Room service'),
